...
R.id.pinyin_on_off ->{
    if(a == 0){
        ...
        binding.pinyinS1.text = "Xiànzài jǐ diǎn?"
        binding.pinyinS2.text = "Xiànzài bā diǎn."
        binding.pinyinS3.text = "Xiànzài shíyī diǎn líng wǔ fēn."
        binding.pinyinS4.text = "Xiànzài shíyī diǎn yī kè."
        binding.pinyinS5.text = "Xiànzài shíyī diǎn bàn."
        binding.pinyinS6.text = "Xiànzài chà shífēn shí'èr diǎn."
        binding.pinyinS7.text = "Nǐ jǐ diǎn xǐzǎo?"
        binding.pinyinS8.text = "Wǒ zǎoshang qī diǎn shí fēn xǐzǎo."
        binding.pinyinS9.text = "Nǐ jǐ diǎn shuìjiào？"
        binding.pinyinS10.text = "Wǒ wǎnshàng bā diǎn sìshí shuìjiào."
        binding.pinyinHeading.text = "Xiànzài Bā Diǎn Bàn"
        binding.pinyinPassage.text = "          Wǒ zǎoshang qī diǎn shífēn qǐchuáng, qī diǎn bàn chī zǎofàn. Chà shí fēn bā diǎn, wǒ hé dìdì yīqǐ qù xuéxiào. Wǒmen bā diǎn bàn kāishǐ shàngkè, zhōngwǔ shí'èr diǎn chī wǔfàn. Xiàwǔ sān diǎn, wǒ hé dìdì yīqǐ huí jiā."
        a = 1
    }else{
        a = 0
